...
func main() {
	...
	flag.IntVar(&autoscale.PodGcWaitSec, "pod-gc-wait-sec", autoscale.PodGcWaitSec, "PodGcWaitSec")
	...
	autoscale.Logger.Infof("[config]PodGcWaitSec: %v", autoscale.PodGcWaitSec)
